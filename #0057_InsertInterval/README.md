...
## Solution
It's an easy problem. We need to deal with the overlapping intervals, otherwise we just copy and paste other intervals. The code tells everything. I have nothing to say.
